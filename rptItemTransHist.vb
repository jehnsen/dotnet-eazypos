...
Public Class rptItemTransHist
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Shockwave_POS.rptItemTransHist.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptItemTransHist
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptItemTransHist = New rptItemTransHist()
        rpt.Site = Me.Site
        Return rpt
    End Function
