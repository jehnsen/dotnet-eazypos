...
Public Class rptReceipt_Charge
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Shockwave_POS.rptReceipt_Charge.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReceipt_Charge
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReceipt_Charge = New rptReceipt_Charge()
        rpt.Site = Me.Site
        Return rpt
    End Function
