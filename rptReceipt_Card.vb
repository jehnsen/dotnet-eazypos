...
Public Class rptReceipt_Card
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Shockwave_POS.rptReceipt_Card.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReceipt_Card
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReceipt_Card = New rptReceipt_Card()
        rpt.Site = Me.Site
        Return rpt
    End Function
