...
Public Class rptPurchaseList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Shockwave_POS.rptPurchaseList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPurchaseList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPurchaseList = New rptPurchaseList()
        rpt.Site = Me.Site
        Return rpt
    End Function
