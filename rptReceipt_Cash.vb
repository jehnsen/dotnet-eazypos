...
Public Class rptReceipt_Cash
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Shockwave_POS.rptReceipt_Cash.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReceipt_Cash
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReceipt_Cash = New rptReceipt_Cash()
        rpt.Site = Me.Site
        Return rpt
    End Function
