...
Public Class rptSalesReportGas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Shockwave_POS.rptSalesReportGas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSalesReportGas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSalesReportGas = New rptSalesReportGas()
        rpt.Site = Me.Site
        Return rpt
    End Function
