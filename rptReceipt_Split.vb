...
Public Class rptReceipt_Split
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Shockwave_POS.rptReceipt_Split.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReceipt_Split
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReceipt_Split = New rptReceipt_Split()
        rpt.Site = Me.Site
        Return rpt
    End Function
