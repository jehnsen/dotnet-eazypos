...
Public Class rptCustPurchHist
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Shockwave_POS.rptCustPurchHist.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCustPurchHist
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCustPurchHist = New rptCustPurchHist()
        rpt.Site = Me.Site
        Return rpt
    End Function
