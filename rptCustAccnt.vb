...
Public Class rptCustAccnt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Shockwave_POS.rptCustAccnt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCustAccnt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCustAccnt = New rptCustAccnt()
        rpt.Site = Me.Site
        Return rpt
    End Function
