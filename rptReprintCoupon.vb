...
Public Class rptReprintCoupon
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Shockwave_POS.rptReprintCoupon.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReprintCoupon
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReprintCoupon = New rptReprintCoupon()
        rpt.Site = Me.Site
        Return rpt
    End Function
